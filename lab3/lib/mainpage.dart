...
import 'package:lab3/squareview.dart';
...
late double screenWidth, screenHeight, resWidth;
 late ScrollController _scrollController;
  ...
  int scrollcount = 5, rowcount = 1, numpr = 0;
                      ...
                      child: Stack(
                        children: <Widget>[
                          Align(
                            ...
                            child: SizedBox(
                              width: resWidth/2,
                              child: Image.asset('assets/images/kakpah.png', fit: BoxFit.contain,
                              ),
                            ),
                          ),
                          Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: Text(numpr.toString() + " found",
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Column(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: <Widget>[
                                      Text(truncateString(productList[index]['prname'].toString()),
            ...
            SpeedDialChild(
                ...
                onTap: () {
                   Navigator.of(context).pop();
                    ...
                    MaterialPageRoute(
                        builder: (BuildContext context) => const SquareView()));              
                    }             
                  ),
                SpeedDialChild(
